...
{
    /// <summary>
    /// Tween for position movement along a bezier curve with speed control.
    /// </summary>
    public class TweenBezierSpeed : TweenComponentValues<Transform, Vector3>
    {
        ...
        public TweenBezierSpeed(Transform targetComponent, Vector3[] controlPoints, float smoothness, float speed)
