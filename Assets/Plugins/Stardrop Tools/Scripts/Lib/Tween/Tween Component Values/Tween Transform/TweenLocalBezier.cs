...
{
    public class TweenLocalBezier : TweenComponentValues<Transform, Vector3>
    {
        private Vector3[] controlPoints;
        private Vector3[] bezierPoints;
        private float smoothness;

        public TweenLocalBezier(Transform targetComponent, Vector3[] controlPoints, float smoothness, float duration)
